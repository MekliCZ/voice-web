...
share-title = Pomozte nám najít další, kteří darují svoji řeč!
...
[[ProjectStatus]]
status-title = Celkový status projektu: podívejte se, jak jsme daleko!
status-contribute = Darujte svoji řeč
status-loading = Načítání...
status-hours = { $hours } zatím ověřených hodin!
status-goal = Další cíl: { $goal }
status-more-soon = Více jazyků již brzy!
...
profile-form-emails = Ano, posílejte mi e-maily. Chtěl bych zůstat o projektu Common Voice informován.
profile-form-language
    .label = Jazyk
profile-form-more-languages = Více jazyků již brzy!
profile-form-accent
    .label = Přízvuk
profile-form-age
    .label = Věk
...
profile-why-content = Poskytnutím informací o sobě zajistíte, že zvukové soubory odeslané do projektu Common Voice budou užitečnější systémům pro rozpoznávání řeči, které tato data používají ke zlepšení rozpoznávání.

[[NotFound]]
notfound-title = Nenalezeno
notfound-content = To, co tu hledáte, tu bohužel není.
